...
export default function Dashboard() {
  ...
  const navItems = [
    ...
    { id: 'logs', label: 'Inventory Logs', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
  ];
          ...
          <div style={styles.contentWrapper}>
            ...
            <div style={styles.statsGrid}>
              ...
              <div style={styles.statCard}>
                ...
                <div>
                  <p style={styles.statLabel}>Inventory Logs</p>
                  <p style={styles.statValue}>{stats.logs}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {(view === 'users' || view === 'logs') && (
          <div style={styles.contentWrapper}>
            <h2 style={styles.pageTitle}>
              {view === 'users' ? 'User Management' : 'Global Inventory Logs'}
            </h2>
            <div style={styles.card}>
              <div style={styles.tableContainer}>
                <table style={styles.table}>
                    ...
                    {listData.length === 0 ? (
                      ...
                      listData.map(item => (
                        <tr key={item.id} style={styles.tr}>
                          ...
                          <td style={styles.td}>{item.email || item.itemName || "No details provided"}</td>
